...
-- Custom keymaps (mostly from theprimeagen)
--
...
require('lazy').setup {
  ...
  -- nvim-autopairs, for bracket matching and cursor placement
  {
  ...
  -- auto closing tags for HTML, tsx and jsx
  {
